...
final _syntaxErrorPattern = RegExp(r"\[.*Line (\d+)\] (Error at .*)");
...
void _defineTestSuites() {
  void rust(Map<String, String> tests) {
    var executable = "target/release/rlox";
    _allSuites["all"] = Interpreter("all", "rust", executable, [], tests);
    _rustSuites.add("all");
  }
